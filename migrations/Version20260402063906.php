 ...
 */
final class Version20260402063906 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE eleve (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, prof_referent_id INT NOT NULL, promotion_id INT DEFAULT NULL, INDEX IDX_ECA105F7F9D4A789 (prof_referent_id), INDEX IDX_ECA105F7139DF194 (promotion_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
