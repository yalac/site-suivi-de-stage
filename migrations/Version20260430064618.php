 ...
 */
final class Version20260430064618 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise ADD tuteur VARCHAR(150) NOT NULL, ADD telephone INT NOT NULL, ADD mail VARCHAR(200) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise DROP tuteur, DROP telephone, DROP mail');
